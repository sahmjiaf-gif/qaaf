  ...
  if (branding?.logoImage) {
    return (
      <div className={`flex items-center justify-center ${className}`}>
        <img src={branding.logoImage} alt="Logo" style={{ height: `clamp(${(branding.logoSize || 100) * 0.35}px, 8vw, ${(branding.logoSize || 100) * 0.48}px)` }} className="w-auto object-contain" />
      </div>
    );
  }
  ...
  return (
    <div className={`flex flex-col items-center justify-center leading-none ${className}`} style={{ fontFamily: theme.fontFamily }}>
      <div className="relative">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-black pt-1">{branding?.logoTitle || 'QAAF'}</h1>
      </div>
